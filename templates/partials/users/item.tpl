<a href="{config.relative_path}/user/{./userslug}" class="btn btn-ghost card card-body border-0  shadow-sm flex-row gap-2 ff-base d-flex align-items-start justify-content-start p-2 text-start">
